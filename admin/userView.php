            ...
            <div class="col-md-12">
                ...
                <div class="box box-primary">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                       <img src="<?php if($row[0]['photo']) echo BASE_URL.'/uploads/user/'.$row[0]['photo']; else echo 'dist/img/avatar5.png'; ?>">
                                    </div>
                                </div>
                        ...
                        <div class="box-footer">
                            <a href="userForm.php?catid=<?php echo $row[0]['id'];?>" class="btn btn-primary" style="color:#fff"><i class="fa fa-pencil"></i> Edit</a>
                        </div>
