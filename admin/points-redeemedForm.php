...
$catid=@$_GET['catid'];
$row=$obj->get_row_by_col('points_redeemed','id',$catid);
$allrow=$obj->get_row_by_col('redeem_gift','status','1');
$alluser=$obj->get_row_by_col('user','status','1')?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        <li><a href="points-redeemed.php" class="btn btn-primary" style="color:#fff"><i class="fa fa-angle-double-left"></i>Back to Redeemed Points</a></li>
      </ol>
    </section>
        ...
        <div class="col-md-6">
          ...
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Please enter redeem details</h3>
            </div>
            <!-- /.box-header -->
              <?php if(@$error){?>
            ...
            <form role="form" method="POST" enctype="multipart/form-data">
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <?php foreach($allrow as $key => $value) 
                    {?>
                      <option <?php if($row[0]['giftid']==$value['id']) echo "selected";?> value="<?php echo $value['id'];?>"><?php echo $value['name'];?> <?php echo $value['worth'];?></option>
                    <?php }?>
                  </select>
                </div>
                <div class="form-group">
              ...
              <div class="box-footer">
                <button type="submit" name="submit-redeem" class="btn btn-primary">Submit</button>
              </div>
            </form>
          </div>
          <!-- /.box -->
