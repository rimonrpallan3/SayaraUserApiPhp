...
<?php include 'inc/sidemenu.php';?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        <li><a href="slideshowForm.php" class="btn btn-primary" style="color:#fff"><i class="fa fa-plus"></i> New Slide</a></li>
      </ol>
    </section>
        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Slideshow lists</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <table id="example2" class="table table-bordered table-hover">
                ...
                <tr>
                  <td><img src="<?php echo BASE_URL.'/images/slideshow/'.$value['file'] ?>" style="width:35px;height:23px" /></td>
                  ...
                  <td><a href="slideshowForm.php?catid=<?php echo $value['id'];?>" class="" data-toggle="tooltip" title="Edit"><i class="fa fa-edit text-blue"></i></a> 
...
$(function() {
  $(".delbutton").click(function(){
    ...
    var info = 'slideshow_id=' + del_id;
    if(confirm("Are you really want to delete Slideshow? "))
    {
      $.ajax({
        type: "POST",
        url: "inc/delete.php",
